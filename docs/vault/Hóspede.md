...
[[Mapa de Funcionalidades]]: F01 (cadastro), F02 (busca), F10 (listagem no hotel), F11 (listagem sem check-in), F13 (tela cadastro/busca), F18/F19 (telas de listagem), F26 (E2E de API), F34 (refatoração visual).
