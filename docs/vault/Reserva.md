...
[[Mapa de Funcionalidades]]: F05 (criação), F15 (tela de criação), F11 (listagem de hóspedes sem check-in), F29 (E2E de API, junto com [[Check-in e Check-out]]), F37 (refatoração visual, junto com [[Check-in e Check-out]]), F33 (E2E de UI, junto com [[Check-in e Check-out]]).
