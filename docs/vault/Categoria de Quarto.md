...
[[Mapa de Funcionalidades]]: F03 (cadastro), F04 (configuração de preço por dia da semana), F14 (tela de configuração de preços), F27 (E2E de API), F35 (refatoração visual).
