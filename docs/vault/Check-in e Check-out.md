...
[[Mapa de Funcionalidades]]: F08 (check-in), F09 (check-out), F16 (tela de check-in), F17 (tela de check-out), F29 (E2E de API). Ambas dependem de F06 e F07 já estarem `passing`.
